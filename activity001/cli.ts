...
//---------Importando as funções do core.ts------------
...
//-----------------Lógica para a interação com o CRUD ------------------ 

if (command === "help") {
  console.log(`
Comandos disponíveis:

bun cli.ts add "Minha nova tarefa"
  Adiciona uma nova tarefa

bun cli.ts list
  Lista todas as tarefas

bun cli.ts update 0 "Tarefa atualizada"
...
bun cli.ts help
  Mostra os comandos para execução
`);
...
//---------- Lógica para um comando desconhecido------------------- 